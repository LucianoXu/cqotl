...
let example1 : lean_file = {
  ...
  declarations = [
    ...
    Lemma {
      ...
      params            = [];
      type_b            = 
        loewnerOrder ket0bra0_v (outerProduct (applyH ketPlus_v) (applyH ketPlus_v));
      body              = Sorry;
    }
  ];
}
...
let relative_lean_file_path = "lean-veri/LeanVeri/Examples/Obligation1-1.lean"
